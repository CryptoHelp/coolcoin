...
int64 nChainStartTime = 1398902400; //Thu, 01 May 2014 00:00:00 GMT
...
const string strMessageMagic = "CoolCoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight == 1)
	{
		nSubsidy = 100000000 * COIN;	// 100 millions coins, that all pow coins
...
static const int64 nTargetTimespan = 30 * 600000;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in CoolCoin
    bool fStrictPayToScriptHash = true; // Always active in CoolCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CoolCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "COOLCOIN.Want to Make Your Own CryptoCurrency?QQ:2968075768";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("812002be26605043899cf5eb8cf20688fdf321ca047eed3ff58f7a1d532996e6"));
...
unsigned char pchMessageStart[4] = { 0xc3, 0x2a, 0x12, 0x56 };
